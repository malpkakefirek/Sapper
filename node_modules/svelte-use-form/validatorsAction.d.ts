 ...
 * ```
 */
export declare function validators(element: FormControlElement, validators: Validator[]): {
    update: (updatedValidators: Validator[]) => void;
};
export declare class ValidatorsActionError extends Error {
}
