import { n as noop, c as create_ssr_component, a as subscribe, e as escape, i as is_promise, b as add_attribute, v as validate_component } from "../../chunks/ssr.js";
...
const Health = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${function(__value) {
    if (is_promise(__value)) {
      ...
      return `  <p style="color: purple;font-weight: bold;" data-svelte-h="svelte-3wb8qk">loading...</p> `;
    }
    return function(data) {
      return `  <p style="color: purple;font-weight: bold;">Status: ${escape(data.response)}</p> <p style="color: purple;">Time: ${escape(data.timing)}</p> `;
    }(__value);
  }(promise)}`;
});
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-t32ptj_START -->${$$result.title = `<title>Home</title>`, ""}<meta name="description" content="Svelte demo app"><!-- HEAD_svelte-t32ptj_END -->`, ""} <section class="svelte-19xx0bt"><h1 class="svelte-19xx0bt" data-svelte-h="svelte-11s73ib"><span class="welcome svelte-19xx0bt"><picture><source${add_attribute("srcset", welcome, 0)} type="image/webp"> <img${add_attribute("src", welcome_fallback, 0)} alt="Welcome" class="svelte-19xx0bt"></picture></span>
		...
		to your new<br>SvelteKit app</h1> <h2 data-svelte-h="svelte-1e36z0s">try editing <strong>src/routes/+page.svelte</strong></h2> ${validate_component(Counter, "Counter").$$render($$result, {}, {}, {})} ${validate_component(Health, "Health").$$render($$result, {}, {}, {})} </section>`;
});
export {
  Page as default
};
